...
enum eNkMAIDCapabilityD1
{
	...
	kNkMAIDCapability_DateImprintSetting		= kNkMAIDCapability_VendorBaseD1 + 0x15f,
	kNkMAIDCapability_DateCounterSelect			= kNkMAIDCapability_VendorBaseD1 + 0x160,
	kNkMAIDCapability_DateCounterData			= kNkMAIDCapability_VendorBaseD1 + 0x161,
	kNkMAIDCapability_DateCounterDispSetting	= kNkMAIDCapability_VendorBaseD1 + 0x162,
	kNkMAIDCapability_RangeFinderSetting		= kNkMAIDCapability_VendorBaseD1 + 0x163,
	...
	kNkMAIDCapability_LiveViewScreenDispSetting	= kNkMAIDCapability_VendorBaseD1 + 0x184		
};
...
{
	kNkMAIDDateImprintSetting_Off = 0,
...
{
	kNkMAIDDateCounterDispSetting_NumberOfDays = 0,
...
{
	kNkMAIDRangeFinderSetting_Off = 0,
	kNkMAIDRangeFinderSetting_On
};
